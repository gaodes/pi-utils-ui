 ...
 * Structurally compatible with ThemeColor from @mariozechner/pi-coding-agent,
 ...
 *
 * Structurally compatible with the `Theme` class from @mariozechner/pi-coding-agent.
 ...
 * Structurally compatible with ToolRenderResultOptions from @mariozechner/pi-coding-agent.
 */
